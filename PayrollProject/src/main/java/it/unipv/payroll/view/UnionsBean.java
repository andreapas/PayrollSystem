			...
			if (answer.equals("Operation completed successfully.")) {
				...
				context.addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_FATAL, "Error!",
								"Something has gone wrong while trying to add " + union.getUnionName() + ". The complete message is: " + answer));
			}
	...
	public String removeUnion() {
		...
		try {
			...
			if (answer.equals("Operation completed successfully.")) {
				...
				context.addMessage(null,
						new FacesMessage(FacesMessage.SEVERITY_FATAL, "Error!",
								"Something has gone wrong while trying to remove " + fireUnionName + ". The complete message is: " + answer));
			}
		} catch (NullPointerException e) {
			System.out.println("Detected a null FacesContext: maybe this bean has been ran for testing.");
		}
